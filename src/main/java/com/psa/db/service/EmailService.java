...
public class EmailService {
	...
	@Lob
	@Value("${spring.mail.smtp.text.remainder}")
	private String mailtextforremainder;
	...
	public String getMailtextforremainder() {
		return mailtextforremainder;
	}

	public void setMailtextforremainder(String mailtextforremainder) {
		this.mailtextforremainder = mailtextforremainder;
	}
	...
	public void SendTimesheetRemainder(String Emailid)
	{
			...
			try {
				...
				message.setText(getMailtextforremainder());
